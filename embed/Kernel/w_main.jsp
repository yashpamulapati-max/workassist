...
<%--for ipad to reload instead of showing old state of page...--%>
    ...
    <link rel="stylesheet" href="<%=fullServletContextPath%>/Kernel/trimble-assist.css?v=20260817d"/>
    <script type="text/javascript" src="<%=fullServletContextPath%>/Kernel/trimble-sdk.js?v=20260817d" defer></script>
    <script type="text/javascript" src="<%=fullServletContextPath%>/Kernel/trimble-assist.js?v=20260817d" defer></script>
